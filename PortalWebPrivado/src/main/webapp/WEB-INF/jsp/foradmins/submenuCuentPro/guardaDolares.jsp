			...
			<nav id="menuSecundario" class="navbar navbar-default">
				<div class="container-fluid">
					...
					<ul class="nav navbar-nav">
						...
						<li id="stiloSubMenuGen"><a href="/portalWebPrivado/secured/cta/GuardaDolares.htm">Guarda D&oacute;lares</a></li>
						<li><a href="/portalWebPrivado/secured/cta/AztecaOro.htm">Azteca Oro</a></li>
						<li><a href="/portalWebPrivado/secured/cta/Bancos.htm">Bancos X</a></li>			
					</ul>
				</div>
			</nav>
			
			<div class="padre">				 
				 <img src="../../resources/imagenes/peque/guardaditodolares.jpg"/>			 
			</div>

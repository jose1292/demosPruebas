...
<tiles:insertDefinition name="templatePriv">
	<tiles:putAttribute name="body">
			<nav id="menuSecundario" class="navbar navbar-default">
				<div class="container-fluid">
					...
					<ul class="nav navbar-nav">
						...
						<li><a href="/portalWebPrivado/secured/contrt/Contratos.htm">Contratos</a></li>
						<li id="stiloSubMenuGen"><a href="/portalWebPrivado/secured/inv/Inversiones.htm">Inversi&oacute;n</a></li>
			...
			<div class="padre">				 
				 <img src="../../resources/imagenes/peque/inversion.jpg"/>			 
			</div>

			...
			<nav id="menuSecundario" class="navbar navbar-default">
				<div class="container-fluid">
					...
					<ul class="nav navbar-nav">
						...
						<li id="stiloSubMenuGen"><a href="/portalWebPrivado/secured/bank/BancoAzteca.htm">Banco Azteca</a></li>
						<li><a href="/portalWebPrivado/secured/bank/Elektra.htm">Elektra</a></li>
						<li><a href="/portalWebPrivado/secured/bank/Bancos.htm">Bancos X</a></li>			
					</ul>
				</div>
			</nav>
			
			<div class="padre">				 
				 <img src="../../resources/imagenes/peque/BancoAzteca.jpg"/>			 
			</div>

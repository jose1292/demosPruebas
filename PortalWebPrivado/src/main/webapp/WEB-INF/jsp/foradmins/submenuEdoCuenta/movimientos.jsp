...
<tiles:insertDefinition name="templatePriv">
	<tiles:putAttribute name="body">
			<nav id="menuSecundario" class="navbar navbar-default">
				<div class="container-fluid">
					...
					<ul class="nav navbar-nav">
						...
						<li id="stiloSubMenuGen"><a href="/portalWebPrivado/secured/mov/Movimientos.htm">Movimientos</a></li>
						<li><a href="/portalWebPrivado/secured/sald/Saldos.htm">Saldo</a></li>
			...
			<div class="padre">				 
				 <img src="../../resources/imagenes/peque/movimientos.jpg"/>			 
			</div>

			...
			<nav id="menuSecundario" class="navbar navbar-default">
				<div class="container-fluid">
					...
					<ul class="nav navbar-nav">
						<li id="stiloSubMenuGen"><a href="/portalWebPrivado/secured/transf/ActualizaDatos.htm">Actualiza Direcci&oacute;n</a></li>
						...
						<li><a href="/portalWebPrivado/secured/update/Telefono.htm">Tel&eacute;fono</a></li>
						<li><a href="/portalWebPrivado/secured/update/Apellidos.htm">Apellidos</a></li>			
					</ul>
				</div>
			</nav>
			<div class="padre">				 
				 <img src="../../resources/imagenes/peque/datos.jpg"/>				 
			</div>			
				</tiles:putAttribute>

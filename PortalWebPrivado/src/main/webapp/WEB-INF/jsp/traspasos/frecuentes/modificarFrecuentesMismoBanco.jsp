...
<body>
				...
				<div align="center">
					...
					<p>Modificar contacto</p>
				</div>
				<form class="form-horizontal ng-pristine ng-valid" action="<c:url value="/traspasos/FrecuentesMismoBanco"/>">	
				<table>				   
				    <tbody>
				    	<tr>
				    		<td align="right" class="form-group">Nombre:&nbsp;</td>
						    <td class="form-group">SANDRA VAZQUEZ ANDRADE</td>
				    	</tr>
				    	<tr>
				        	<td align="right" class="form-group">Alias:&nbsp;</td>
						    <td><input type="text" required class="form-control" id="alias" placeholder="" name="alias" value="macsal50"></td>
		        		</tr>
                      	<tr>				            
							<td align="right" class="form-group">Cuenta:&nbsp;</td>
						    <td><input type="text" required class="form-control" id="cuenta" placeholder="" name="cuenta" value="9092 0100 5396 67"></td>
				        </tr>
				        <tr>
				    		<td align="right" class="form-group">Tipo:&nbsp;</td>
						    <td class="form-group">GUARDADITO</td>
				    	</tr>
						<tr>                         	
				            <td align="right" class="form-group">Email:&nbsp;</td>
						    <td><input type="email" required class="form-control" id="email" placeholder="" name="email" value="jmedrano@elektra.com.mx"></td>
				        </tr>
				        <tr>                         	
					...
					<br><br>
						<div class="form-group">        
							<div align="center">
						        <button type="submit" class="btnContinuar" onclick="history.back()">Regresar</button> <button type="submit" class="btnContinuar" onclick="history.back()">Eliminar contacto</button> <button type="submit" class="btnContinuar">Modificar</button>
						    </div>						      
						</div>
				</form>
				</div>

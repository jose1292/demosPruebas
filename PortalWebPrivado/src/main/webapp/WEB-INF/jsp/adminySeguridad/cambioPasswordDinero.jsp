			...
			<div class=" textoSeccionSM ">
				...
				<table>
					<tbody>						
						...
						<tr>
							<td>
								<p><span class="TextoSpanCC">Contraseña de Confirmación de Movimientos de Dinero</span></p>
							</td>
						</tr>				
					</tbody>
				</table>
				...
				<table>
					<tbody><tr>
						<td align="center">
							<div>					 
							  <form class="form-horizontal ng-pristine ng-valid" action="<c:url value="/adminySeguridad/cambioPasswordDineroFin"/>">						  	
							  	 <div class="form-group">
							      <label class="control-label col-sm-6" for="pwd">Contraseña Actual de confirmación:</label>
							      <div class="col-sm-6">
							        <input type="password" required  class="form-control" id="pwd" placeholder="Digita Contraseña Actual" name="pwd">
							      </div>
							    </div>
							    <div class="form-group">
							      <label class="control-label col-sm-6" for="pwd">Nueva Contraseña de confirmación*:</label>
							      <div class="col-sm-6">          
							        <input type="password" required  class="form-control" id="pwd" placeholder="Digita la nueva Contraseña" name="pwd">
							      </div>
							    </div>
							    <div class="form-group">
							      <label class="control-label col-sm-6" for="pwd">Confirme su contraseña de confirmación*:</label>
							      <div class="col-sm-6">          
					...
					<tr>
						<td>
							...
							<tr>
								<td>&nbsp;</td>
								<td class="texto" width="699"><br><p>Esta contraseña te sirve para confirmar tus <span class="TextoSpanCC">MOVIMIENTOS DE DINERO: Traspasos a terceros mismo banco, Transferencias interbancarias: Mismo día-SPEI, y Día siguiente-TEF,Pago de servicios, Compra de tiempo aire, Pago de tarjetas de crédito de otros bancos y Pago de Créditos de otros bancos.</span> </p></td>
								<td>&nbsp;</td>
							</tr>							
						</tbody></table>
						</td>
